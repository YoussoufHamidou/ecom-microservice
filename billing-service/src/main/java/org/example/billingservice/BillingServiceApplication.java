...
import org.example.billingservice.feign.CustomerRestCient;
...
public class BillingServiceApplication {
   ...
   @Bean
	CommandLineRunner commandLineRunner(BillRepository billRepository,
										...
										CustomerRestCient customerRestCient,
										ProductRestClient productRestClient) {
     return args -> {
		 Collection<Customer> customers = customerRestCient.getAllCustomers().getContent();
